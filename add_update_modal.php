...
$event_sql = "SELECT e.id, e.event_name, e.event_date, e.department_id, s.name AS sport_name, d.name AS department_name, s.is_individual
              FROM events e
            ...
            <div id="AddEvent" class="tab-content">
                ...
                <form action="process_add_event.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select id="event_sport" name="sport_id" required>
